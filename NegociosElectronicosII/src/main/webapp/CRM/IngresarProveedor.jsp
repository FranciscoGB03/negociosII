                    ...
                    <div class="inner-block">
                        ...
                        <form>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    <label for="formGroupExampleInput5">Telefono</label>
                            ...
                            <div class="row"> 
                                ...
                                <div class="form-group col-sm-3">
                                    <label for="formGroupExampleInput7">Estado</label>
                                    <input type="text" class="form-control" id="estado" placeholder="Estado">
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="formGroupExampleInput8">Cuenta Bancaria</label>
                                    <input type="text" class="form-control" id="cuentabancaria" placeholder="Cuenta bancaria">
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="formGroupExampleInput8">Nombre</label>
                                    <input type="text" class="form-control" id="nombre" placeholder="Nombre">
                                </div>
                                <div class="form-group col-sm-3">
                                    <label for="formGroupExampleInput8">Municipio</label>
                                    <input type="text" class="form-control" id="municipio" placeholder="Municipio">
                                </div>
                                
                            </div>
                            <br>
                            <button type="submit" <button type="button" class="btn btn-success btn-lg btn-block">Registrar</button>
                        </form>
                    </div>
                    <div class="clearfix"> </div>
                </div>
